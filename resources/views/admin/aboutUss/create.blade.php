        ...
        <form method="POST" action="{{ route("admin.about-uss.store") }}" enctype="multipart/form-data">
            ...
            <div class="row justify-contnet-between">
                ...
                <div class="form-group col-3">
                    ...
                    <input class="form-control {{ $errors->has('president_description') ? 'is-invalid' : '' }}" type="text" name="president_description" id="president_description" value="{{ old('president_description', '') }}">
