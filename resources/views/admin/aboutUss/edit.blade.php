    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.about-uss.update", [$aboutUs->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('site_name') ? 'is-invalid' : '' }}" type="text" name="site_name" id="site_name" value="{{ old('site_name', $aboutUs->site_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('president_description') ? 'is-invalid' : '' }}" type="text" name="president_description" id="president_description" value="{{ old('president_description', $aboutUs->president_description) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link') ? 'is-invalid' : '' }}" type="text" name="link" id="link" value="{{ old('link', $aboutUs->link) }}">
                @if($errors->has('link'))
                    <div class="invalid-feedback">
                        {{ $errors->first('link') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" type="text" name="description" id="description" value="{{ old('description', $aboutUs->description) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" type="text" name="address" id="address" value="{{ old('address', $aboutUs->address) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="text" name="email" id="email" value="{{ old('email', $aboutUs->email) }}">
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('author_seo') ? 'is-invalid' : '' }}" type="text" name="author_seo" id="author_seo" value="{{ old('author_seo', $aboutUs->author_seo) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sitemap_link_seo') ? 'is-invalid' : '' }}" type="text" name="sitemap_link_seo" id="sitemap_link_seo" value="{{ old('sitemap_link_seo', $aboutUs->sitemap_link_seo) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('keywords_seo') ? 'is-invalid' : '' }}" name="keywords_seo" id="keywords_seo">{{ old('keywords_seo', $aboutUs->keywords_seo) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description_seo') ? 'is-invalid' : '' }}" name="description_seo" id="description_seo">{{ old('description_seo', $aboutUs->description_seo) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('location') ? 'is-invalid' : '' }}" type="text" name="location" id="location" value="{{ old('location', $aboutUs->location) }}">
...
<script>
    ...
    init: function () {
@if(isset($aboutUs) && $aboutUs->aboutus_image)
      var file = {!! json_encode($aboutUs->aboutus_image) !!}
...
Dropzone.options.galleryDropzone = {
    ...
    init: function () {
@if(isset($aboutUs) && $aboutUs->gallery)
      var files = {!! json_encode($aboutUs->gallery) !!}
          for (var i in files) {
          var file = files[i]
          this.options.addedfile.call(this, file)
          this.options.thumbnail.call(this, file, file.preview ?? file.preview_url)
